<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="ChatWebiste_2._0.Registration" %>
...
<body>
    ...
    <div class="container">
        ...
        <form method="post" runat="server">
            <!-- Username Field  OnTextChanged="txtUsername_TextChanged" -->
            <div class="form-group">
                <label for="txtUsername">Username:</label>
                <asp:TextBox ID="txtUsername" runat="server" placeholder="Enter username" CssClass="form-control"  AutoPostBack="true" required="true" />
            </div>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" placeholder="Confirm password" CssClass="form-control" required="true" />
            </div>
